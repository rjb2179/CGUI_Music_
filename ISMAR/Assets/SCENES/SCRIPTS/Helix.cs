...
public class Helix : MonoBehaviour {
    ...
    private MySpotifyPlaylistsTracks_Helix myPlaylistsTracksSpotifyScript; 
        ...
        MySpotify.SpotifyData data, Transform screenTransform, float helixRadius)
    {
        ...
        Debug.Log(spotifyData.ID);
        Debug.Log(spotifyData.type); 
        ...
        // myPlaylistsTracksSpotifyScript = GameObject.FindGameObjectWithTag("InstructionSign").GetComponent<MySpotifyPlaylistsTracks_Helix>();
    ...
    public void DisplaySpotifyObjects(List<string> ids, List<Texture2D> textures, string objectType, List<string> previewURLs = null)
    {
        ...
        for (int i = 0; i < numberOfObjects; i++)
        {
            ...
            InteractibleObject_Helix interactibleScript = myObject.AddComponent<InteractibleObject_Helix>();
