...
public class GRID_MySpotifyPlaylistsTracks : MonoBehaviour
{
    // Spotify API 
    ...
    [HideInInspector]
    public CurvedGrid curvedGridScript;

    public void StartSpotifySearch(string playlistID, CurvedGrid script)
    {
        ResetVariables();
        curvedGridScript = script;
    ...
    IEnumerator SearchForPlaylists(string userID, string playlistID)
    {
        ...
        curvedGridScript.DisplaySpotifyObjects(trackIDs, trackTextures, objectType, trackPreviewURLs);
    }
