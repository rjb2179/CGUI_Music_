...
public class GazeSelectionTarget : MonoBehaviour, IGazeSelectionTarget
{
    ...
    public virtual bool OnManipulationStarted(InteractionSourceKind source, Vector3 relativePosition, Ray ray)
    {
        return false;
    }

    public virtual bool OnManipulationUpdated(InteractionSourceKind source, Vector3 relativePosition, Ray ray)
    {
        return false;
    }

    public virtual bool OnManipulationCompleted(InteractionSourceKind source, Vector3 relativePosition, Ray ray)
    {
        return false;
    }

    public virtual bool OnManipulationCanceled(InteractionSourceKind source, Vector3 relativePosition, Ray ray)
    {
        return false;
    }
