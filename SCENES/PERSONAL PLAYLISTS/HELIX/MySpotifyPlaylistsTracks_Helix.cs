...
public class MySpotifyPlaylistsTracks_Helix : MonoBehaviour
{
    ...
    public void StartSpotifySearch(string playlistID, Helix script)
    {
        ResetVariables();
        helixScript = script;
    ...
    IEnumerator SearchForPlaylists(string userID, string playlistID)
    {
        ...
        helixScript.DisplaySpotifyObjects(trackIDs, trackTextures, objectType, trackPreviewURLs);
    }
